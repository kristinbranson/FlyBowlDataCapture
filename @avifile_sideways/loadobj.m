...
%LOADOBJ Load filter for avifile_sideways objects.
%
%    OBJ = LOADOBJ(B) is called by LOAD when an avifile_sideways object is 
...
if isempty(B.Bitmapheader.Colormap)
    obj = avifile_sideways(filename, 'fps', fps, 'Compression', compression, ...
