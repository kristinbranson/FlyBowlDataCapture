...
%   associated with AVIOBJ, which is an AVIFILE_SIDEWAYS object obtained from
%   AVIFILE_SIDEWAYS.  
%
%   See also AVIFILE_SIDEWAYS/AVIFILE_SIDEWAYS, AVIFILE_SIDEWAYS/ADDFRAME, and MOVIE2AVI.

%   Copyright 1984-2007 The MathWorks, Inc.
%   $Revision: 1.1.6.7 $  $Date: 2008/12/04 22:38:33 $

if ~isa(aviobj,'avifile_sideways')
   error('MATLAB:aviclose:invalidInputArgument','First input must be an AVIFILE_SIDEWAYS object.');
end
