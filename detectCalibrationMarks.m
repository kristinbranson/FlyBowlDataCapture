...
if ~isempty(saveName),
  save(saveName,'offX','offY','offTheta','scale',...
    'calibrationPoints','bowlMarkerPoints',...
    'featureStrengths','bowlMarkerTheta','dtheta',...
    'nPairs','nLeftCalibrationPoints','nRightCalibrationPoints',...
    'nTopCalibrationPoints','nBottomCalibrationPoints');
end
