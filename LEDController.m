...
classdef LEDController < handle
    ...
    methods
        ...
        function totalSteps = addOneStep(obj,oneStep)
            if  ~(obj.serialPort == 0)
              x = [oneStep.NumStep, oneStep.RedIntensity, oneStep.RedPulseWidth, oneStep.RedPulsePeriod,...
                oneStep.RedPulseNum, oneStep.RedOffTime, oneStep.RedIteration, oneStep.GrnIntensity,...
