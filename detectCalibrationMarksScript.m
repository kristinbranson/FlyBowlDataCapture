...
for i = 1:length(expDirs),
  ...
  [registerfn,...
    calibrationData(i).offX,...
    calibrationData(i).offY,...
    calibrationData(i).offTheta,...
    calibrationData(i).scale,...
    calibrationData(i).calibrationPoints,...
    calibrationData(i).bowlMarkerPoints,...
    calibrationData(i).featureStrengths,...
    calibrationData(i).bowlMarkerTheta,...
    calibrationData(i).dtheta,...
    calibrationData(i).bkgdImage,...
    calibrationData(i).nPairs,...
    calibrationData(i).nLeftCalibrationPoints,...
    calibrationData(i).nRightCalibrationPoints,...
    calibrationData(i).nTopCalibrationPoints,...
    calibrationData(i).nBottomCalibrationPoints] = ...
    detectCalibrationMarks('annName',annName,params{:});
