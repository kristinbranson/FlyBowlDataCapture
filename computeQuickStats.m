...
htable1 = uitable(fig,'Units','Pixels','Position',TablePos1,...
  'Data',[rowheaders1(:),data1],'ColumnName',[{'Field'},colheaders1],'RowName',[],...
  'FontUnits','Pixels','FontSize',10.6667,...
  'ColumnFormat',repmat({'char'},[1,length(colheaders1)+1]),...
  'ColumnWidth',[{TableRowLabelWidth},repmat({TableColumnWidth},[1,length(colheaders1)])],...
  'BackgroundColor',[1,1,1]); %#ok<NASGU>
htable2 = uitable(fig,'Units','Pixels','Position',TablePos2,...
  'Data',[rowheaders2(:),data2],'ColumnName',[{'Field'},colheaders2],'RowName',[],...
  'FontUnits','Pixels','FontSize',10.6667,...
  'ColumnFormat',repmat({'char'},[1,length(colheaders2)+1]),...
  'ColumnWidth',[{TableRowLabelWidth},repmat({TableColumnWidth},[1,length(colheaders2)])]); %#ok<NASGU>
