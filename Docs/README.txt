...
* {{Rearing_ActivityPeaks}}: List of possible Activity Peak times. These should correspond to the ordered list of Incubator IDs \[{{10:00,15:00}}\].
* {{Rearing_LightsOns}}: List of times the lights go on in the incubator. These should correspond to the ordered Incubator IDs list \[{{08:00,13:00}}\]. 
* {{Rearing_LightsOffs}}: List of times the lights go off in the incubator. These should correspond to the ordered Incubator IDs list \[{{15:00,21:00}}\]. 
...
* {{PreAssayHandling_DOBStart_Range}}: Range of DOB Starts to show -- minimum and maximum number of days before today \[{{1,7}}\].
* {{PreAssayHandling_DOBEnd_Range}}: Range of DOB Ends to show -- minimum and maximum number of days before today \[{{0,3}}\].
...
* *Activity Peak*: 24-hour time of peak activity for the flies. The possible values for this are set by the {{Rearing_ActivityPeaks}} parameter. One activity peak should be used in the morning, the other in the afternoon. \[We should maybe remove this or Incubator ID, as this will always correspond to incubator ID?\]. 
...
* *DOB*: Range of dates of birth for the flies. Possible values are set by {{PreAssayHandling_DOBStart_Range}} and {{PreAssayHandling_DOBEnd_Range}}. \[Is there more information for this available than just the Cross Date?\]
...
** {{datetime}}: Date and time recording was started. 
...
--- {{computer}}
**** {{id}}: ID of the computer, queried using {{system('hostname'}}}. T
...
**** {{crossdate}}: Date the cross for these flies was performed, set by the Cross Date control. 
**** {{age}}: Range of flies' ages in days, computed from DOB range control. 
**** {{count}}: Number of flies. This is currently set to 0 as we have not yet counted the number of flies. 
---- {{rearing\_protocol}}
***** {{id}}: Name of rearing protocol file, set by activity peak and {{MetaData\_RearingProtocols}} parameter. 
***** {{incubator}}: ID of the incubator the flies were raised in, set by Incubator ID control. 
---- {{handling\_protocol}}, {{type = "sorting"}}
...
---- {{handling\_protocol}}, {{type = "starvation"}}
***** {{handler}}: LDAP of person who moved the flies to starvation material, set by Starver control. 
***** {{time}}: Hours the flies have been starved, computed from Starvation Date and Time controls. 
--- {{environment}}
...
{noformat}
<?xml version="1.0"?>
<experiment assay="FlyBowl" protocol="ExperimentProtocol0001" datetime="2010-09-27T15:34:59" aborted="1" experimenter="bransonk" shiftflytemp_time="4.225002" fliesloaded_time="3.640998" >
  <apparatus rig_id="2" plate_id="01" bowl_id="1">
    ...
    <flies line="GMR_34A04_AE_01" effector="TrpA" crossdate="2010-09-17" age="4.000000,7.000000" count="0">
      <rearing_protocol id="RearingProtocol0002_Afternoon" incubator="1" />
      <handling_protocol id="SortingProtocol0001" type="sorting" handler="hirokawaj" time="22.849824" />
      <handling_protocol id="StarvationProtocol0001" type="starvation" handler="robiea" time="54.099824" />
    </flies>
    <environment temperature="NaN" humidity="60.000000" />
    <note type="behavioral">Here is a note. </note>
    <note type="technical">None</note>
    <flag type="redo" reason="FLIES LOOK SICK"/>
  </apparatus>
</experiment>
{noformat}
